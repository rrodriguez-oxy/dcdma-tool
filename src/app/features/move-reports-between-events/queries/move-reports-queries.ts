// â”€â”€â”€ Move Reports Between Events Queries â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export function searchEvents(wellId: string): string {
  return `
    SELECT event_id "event_id",
           event_code "event_code",
           event_type "event_type",
           event_objective_1 "event_objective_1",
           TO_CHAR(date_ops_start, 'MM/DD/YYYY') "start_date",
           TO_CHAR(date_ops_end, 'MM/DD/YYYY') "end_date"
    FROM dm_event
    WHERE well_id = '${wellId}'
    ORDER BY date_ops_start
  `;
}

// ─── Compare Records ─────────────────────────────────────────────────────────
// Returns batched queries comparing source/target event record counts with
// date-aware move/add logic matching the manual stored-procedure approach.
...
export function compareRecords(
  ...
  // ── Via parent with direct date_report ──
  ...
  const selects = rows.map(([name, moveExpr, addExpr]) =>
    `SELECT '${name}' "Table_name", ${srcCnt(name)} "sourceCount", ${tgtCnt(name)} "targetCount", ${moveExpr} "toMove", ${addExpr} "toAdd" FROM DUAL`
  );
...
// â”€â”€â”€ Full ordered list of table names (matches countSourceRecords output) â”€â”€â”€â”€
...
export const ALL_TABLE_NAMES: string[] = [
  ...
  'CD_WELLHEAD',
  'CD_WELLHEAD_COMP',
  'CD_WELLHEAD_COMPLETION_LINK',
  'CD_WELLHEAD_COMP_OUTLET',
  'CD_WELLHEAD_HANGER',
  'CD_WELLHEAD_HANGER_CONTROL',
  'CD_WELLHEAD_TEST',
  'CD_WEQP_CONV_PUMP',
  'CD_WEQP_GRAVEL_PACK_SCREEN',
  'DM_ACTIVITY',
  'DM_AFE_EVENT_LINK',
  'DM_ANCHOR_OP',
  'DM_BHA_OP',
  ...
  'DM_DAILY_COMPLETION',
  'DM_DAILY_CT_OP',
  'DM_DAILY_DITCH_MAGNET',
  'DM_DAILY_FLARING',
  'DM_DAILY_EQUIPMENT',
  'DM_DAILY_GLV_TEST',
  'DM_DAILY_NOTIFICATION',
  'DM_DAILY_SSSV_TEST',
  'DM_DAILY_UBD',
  'DM_DEGASSER_OP',
  'DM_DISCHARGE',
  ...
  'DM_ESP',
  'DM_FISHING',
  'DM_FISHING_FREE_POINT',
  'DM_FISHING_RESPONSIBLE',
  'DM_FISHING_RESULTS',
  'DM_FISHING_STRING_SHOT',
  'DM_FLUID_BALANCE',
  'DM_FLUID_HAUL',
  'DM_FLUID_HAUL_DETAIL',
  'DM_FLUID_INPUT',
  'DM_FLUID_LOSS',
  'DM_FLUID_LOSS_HOLE_SECT',
  'DM_GAS_LIFT',
  'DM_GAS_PEAK',
  'DM_GENERAL_WORK',
  'DM_GEOLOGY_DAILY',
  ...
  'DM_INCIDENT_COST',
  'DM_INCIDENT_DETAIL',
  'DM_INTERMEDIATE_CIRC',
  'DM_KICK',
  'DM_LOG',
  'DM_MATERIAL_TRANSFER',
  'DM_MOTOR_OP',
  'DM_MUDGAS',
  'DM_MUD_PRODUCT',
  'DM_MUD_PRODUCT_TRAN',
  ...
  'DM_RIG_OPERATION_EVENT_LINK',
  'DM_RISERLINE_OP',
  'DM_RISER_OP',
  'DM_SAFETY',
  'DM_SAFETY_INCIDENT',
  'DM_SAFETY_KICK_DETECT',
  'DM_SHAKERSCREEN_OP',
  'DM_SHAKER_OP',
  'DM_SLICKLINE',
  'DM_SLICKLINE_DAILY',
  'DM_SLICKLINE_PURPOSE',
  'DM_SLICKLINE_SOLID',
  'DM_SPILLS',
  'DM_STIM_FET_TEST',
  'DM_STIM_FLOWBACK',
  ...
  'DM_STIM_FLUID',
  'DM_STIM_FLUID_ADD',
  'DM_STIM_FLUID_SCHEDULE',
  'DM_STIM_JOB',
  'DM_STIM_PUMPING_DIAG',
  'DM_STIM_PUMP_FB_TEST',
  'DM_STIM_RES_INTERVAL',
  'DM_STIM_STAGE',
  'DM_STIM_STAGE_SUPPLEMENT',
  'DM_STIM_STEP_TEST',
  'DM_STIM_TREATMENT',
  'DM_STIM_TREATMENT_AC_COMP',
  'DM_STIM_TREATMENT_ADDITIVE',
  'DM_STIM_TREATMENT_FLUID',
  'DM_STIM_TREATMENT_PROPPANT',
  'DM_SUPPORT_VESSEL_DAILY',
  'DM_TRANSFER_DETAIL',
  'DM_TRANSFER_SUMMARY',
  'DM_UNDERWATER_DETAIL',
  'DM_UNDERWATER_EQUIPMENT',
  'DM_UNDERWATER_MATERIAL',
  'DM_UNDERWATER_MATERIAL_TRAN',
  'DM_UNDERWATER_OP',
  'DM_UNDERWATER_PERS',
  'DM_VESSEL_BULK_TRAN',
  'DM_WB_OBSTRUCTION_STATUS',
  'DM_WEATHER_CHECK',
  'DM_WEATHER_CURRENT',
  'DM_WELLBORE_ZONE_ACTIVITY',
  'DM_WELL_PLAN',
  'DM_WELL_PLAN_OFFSET',
  'DM_WORK_DETAIL',
];
